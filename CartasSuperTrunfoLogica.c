...
int main() {
    char jogarNovamente;
    int primeiroAtributo, segundoAtributo, escolhaAtributo;
    ...
    do {
       ...
       // };
        ...
        srand(time(NULL)); 
        estado = rand() % 1000 + 1;
        populacao = rand() % 100000000 + 10000;
        area = (float)(rand() % 150000 + 1000);
        pib = (float)(rand() % 500 + 10);
        pontosturisticos = rand() % 100 + 1;    
        densidadepopulacional = populacao / area;
        pibpercapita = (pib * BILHAO) / populacao;
        superpoder = populacao + area + pib + pontosturisticos + (1 / densidadepopulacional) + pibpercapita;
